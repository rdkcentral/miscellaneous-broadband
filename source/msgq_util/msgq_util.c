...
typedef enum event_t
{
    ...
    GM_EVENT_DEVICE_MAC_UPDATION,
    GM_EVENT_REMOTEDEV_NUMOFENTRIES_UPDATED,
    GM_EVENT_WAN_SECONDARY_L3CONNECTION_UP,
    GM_EVENT_WAN_SECONDARY_L3CONNECTION_DOWN,
    GM_EVENT_MAX
}event_t;
...
printf ("\n GM_EVENT_GRE_TUNNEL_ACTIVE = 4 \n");
    ...
    printf ("\n GM_EVENT_DEVICE_MAC_UPDATION = 39 \n");
    printf ("\n GM_EVENT_REMOTEDEV_NUMOFENTRIES_UPDATED = 40 \n");
    printf ("\n GM_EVENT_WAN_SECONDARY_L3CONNECTION_UP = 41 \n");
    printf ("\n GM_EVENT_WAN_SECONDARY_L3CONNECTION_DOWN = 42 \n");
